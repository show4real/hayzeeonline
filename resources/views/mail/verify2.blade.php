...
<div style="margin:0px auto;max-width:640px;background:transparent;"><table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:transparent;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:40px 0px;"><!--[if mso | IE]>
      ...
      <![endif]--><div style="cursor:auto;color:white;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:36px;font-weight:600;line-height:36px;text-align:center;">
     Welcome on Board joining our Affiliate market!</div><!--[if mso | IE]>
      </td></tr></table>
      ...
      <![endif]--><div aria-labelledby="mj-column-per-100" class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%;"><table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0"><tbody><tr><td style="word-break:break-word;font-size:0px;padding:0px 0px 20px;" align="left"><div style="cursor:auto;color:#737F8D;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:16px;line-height:24px;text-align:left;">
            <p><img src="{{ asset('logo/logo5.png') }}" alt="Hayzeeonline" title="None" width="500" style="height: auto;"></p>
...
<p>Wowwee! Thanks for registering an account with Hayzee Computer Resources!</p>
<p>  Refer us today and get your percentage instantly
            Generate your referral code as soon as you verify your Email</p>
            ...
            <tbody>
                <tr>
                    ...
                    <a href="https://hayzeeonline.com/verify/{{$email}}" style="text-decoration:none;line-height:100%;background:#7289DA;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px;" target="_blank">
            Verify Email
      ...
      Sent by Hayzee Computer Resources • <a href="https://hayzeeonline.com/" style="color:#1EB0F4;text-decoration:none;" target="_blank">Visit our Webiste</a> • <a href="https://twitter.com/hayzeeonline" style="color:#1EB0F4;text-decoration:none;" target="_blank">@hayzeeonline</a>
     ...
     Spectral Business Oyo State, Ibadan, Ibadan
